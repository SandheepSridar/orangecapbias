"""
Publication-quality figures for the IPL Orange Cap bias paper.
Outputs PNG (300 DPI) and SVG to outputs/figures/.
"""
...
# ── Figure 1 — Orange Cap winner positions ────────────────────────────────────
...
ax.set_title("Balls Faced per Season by Batting Position Group", pad=12)
ax.tick_params(axis="x", length=0)
ax.grid(axis="x", visible=False)
...
ax.set_title("Run Distribution by Phase and Batting Position Group", pad=12)
ax.set_ylim(0, 108)
